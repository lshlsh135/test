...
class result_calculator:
    ...
    def rolling_12month_return_1factor(self,i):
        factor_name = [i]
        ...
        plt.tight_layout()
        factor_name = ['ir_200202='+str(ir_20020228), 'ir_200802='+str(ir_20080229), 'win_200802='+str(winrate_20080229),'win_200202='+str(winrate_20020228)] # 파일 이름에 팩터를 넣지 않은 이유는 '/' 가 들어갈 수 없기 때문
    ...
    def rolling_12month_return_6factor(self,i,j,z,p,k,u):
        factor_name = [i,j,z,p,k,u]
    ...
    def rolling_12month_return_whole_factor(self,factors):
        factor_name = [factors]
